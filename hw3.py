...
print("Beam")
print("Expected1: Arad, Sibiu, Fagaras, Bucharest")
expected1 = set(['Arad', 'Sibiu', 'Fagaras', 'Bucharest'])
expected2 = set(['Arad', 'Sibiu', 'Rimnicu', 'Pitesti', 'Bucharest'])
print("Expected:\t" + str(expected1) + " or " + str(expected2))
got = set(nx.beam_path(g, 'Arad', 'Bucharest', heuristic=dist, weight='weight'))
print("Got:\t" + str(got))
print(got == expected1 or got == expected2)
